# Generated by Django 3.2.3 on 2025-03-27 18:54
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ingredients', models.ManyToManyField(related_name='recipes', to='recipes.Ingredient', verbose_name='Ингридиенты и их количество')),
            ],
            options={
                'verbose_name': 'Рецепт',
        ...
        migrations.AddField(
            model_name='follow',
            name='follow',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='followers', to=settings.AUTH_USER_MODEL, verbose_name='Пользователь на которого подписались'),
        ),
        migrations.AddField(
            model_name='follow',
            name='user',
